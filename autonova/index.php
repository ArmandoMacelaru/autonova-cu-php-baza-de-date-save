...
<body>
    ...
    <?php else: ?>
        <a href="login.php" style="color:white;">Contul meu</a>
    <?php endif; ?>
            </nav>
        </div>
    </header>
        ...
        <div class="catalog-grid">
            ...
            if ($conn->connect_error) {
                ...
                if ($result && $result->num_rows > 0) {
                    ...
                    echo '<a href="adauga.php" style="background: var(--accent-color); color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none;">➕ Adaugă mașină</a>';
                    echo '</div>';
                }
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function toggleTheme() {
        const current = localStorage.getItem("autonova_theme") || "light";
        applyTheme(current === "light" ? "dark" : "light");
    }
    applyTheme(localStorage.getItem("autonova_theme") || "light");
    const btn = document.getElementById("themeToggle");
