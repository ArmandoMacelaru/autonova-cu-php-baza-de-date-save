...
<body>
    ...
    <div class="container">
        ...
        <div class="catalog-grid">
            ...
            // Interogare pentru a prelua toate mașinile
            ...
            if ($result->num_rows > 0) {
                while($masina = $result->fetch_assoc()) {
                    ...
                    // Generare link detaliu (folosește ID-ul din baza de date)
                    ...
                    <div class="car-card">
                        ...
                        <div class="car-image">
                            <img src="' . $masina['imagine'] . '" alt="' . $masina['marca'] . ' ' . $masina['model'] . '">
                            <button class="favorite-btn">♥</button>
                        </div>
                        <div class="car-content">
                            <h3 class="car-title">' . $masina['marca'] . ' ' . $masina['model'] . '</h3>
                            <p class="car-seller">Dealer auto</p>
                            <div class="car-details">
                                <div class="car-detail">📅 ' . $masina['an'] . '</div>
                                <div class="car-detail">🛣️ ' . number_format($masina['kilometraj'], 0, ',', '.') . ' km</div>
                                <div class="car-detail">⛽ ' . $masina['combustibil'] . '</div>
                                <div class="car-detail">⚙️ ' . $masina['cutie_viteze'] . '</div>
                            </div>
                ...
                echo '<p style="grid-column: 1 / -1; text-align: center; padding: 40px;">Nu există mașini în baza de date.</p>';
            }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            compareBtns.forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    alert('Mașina cu ID ' + carId + ' a fost adăugată la comparație!');
                });
            });

            console.log('Site-ul AutoNova este conectat la baza de date! 🚗💾');
        });
    </script>
</body>
</html>